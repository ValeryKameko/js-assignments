[![rest Rolling Scopes](http://brest.rollingscopes.com/images/logo_rs_text.svg)](http://brest.rollingscopes.com/)
#Brest Rolling Scopes School
## Javascript Assignments  [![Build Status](https://travis-ci.org/ValeryKameko/js-assignments.svg?branch=master)](https://travis-ci.org/ValeryKameko/js-assignments)
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/ValeryKameko/js-assignments/builds).
